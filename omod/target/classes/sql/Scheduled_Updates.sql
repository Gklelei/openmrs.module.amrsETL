...
CREATE PROCEDURE sp_update_etl_program_discontinuation(IN last_update_time DATETIME)
  BEGIN
    insert into amrsemr_etl.etl_patient_program_discontinuation(
      patient_id,
      uuid,
      visit_id,
      visit_date,
...
CREATE PROCEDURE sp_update_etl_mch_enrollment(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_mch_enrollment(
      patient_id,
      uuid,
      visit_id,
      visit_date,
...
CREATE PROCEDURE sp_update_etl_mch_antenatal_visit(IN last_update_time DATETIME)
  BEGIN
    insert into amrsemr_etl.etl_mch_antenatal_visit(
      patient_id,
      uuid,
      visit_id,
      visit_date,
...
CREATE PROCEDURE sp_update_etl_mch_delivery(IN last_update_time DATETIME)
  BEGIN
    insert into amrsemr_etl.etl_mchs_delivery(
      patient_id,
      uuid,
      provider,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_mch_discharge(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_mchs_discharge(
      patient_id,
      uuid,
      provider,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_mch_postnatal_visit(IN last_update_time DATETIME)
  BEGIN
    insert into amrsemr_etl.etl_mch_postnatal_visit(
      patient_id,
      uuid,
      visit_id,
      visit_date,
...
CREATE PROCEDURE sp_update_etl_hei_enrolment(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_hei_enrollment(
      patient_id,
      uuid,
      provider,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_hei_follow_up(IN last_update_time DATETIME)
  BEGIN
    insert into amrsemr_etl.etl_hei_follow_up_visit(
      patient_id,
      uuid,
      provider,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_hei_immunization(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_hei_immunization(
      patient_id,
      visit_date,
      created_by,
      date_created,
...
CREATE PROCEDURE sp_update_etl_tb_enrollment(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_tb_enrollment(
      patient_id,
      uuid,
      provider,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_tb_follow_up_visit(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_tb_follow_up_visit(
      patient_id,
      uuid,
      provider,
      visit_id ,
...
CREATE PROCEDURE sp_update_etl_tb_screening(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_tb_screening(
        patient_id,
        uuid,
        provider,
        visit_id,
...
CREATE PROCEDURE sp_update_drug_event(IN last_update_time DATETIME)
  BEGIN
    ...
    INSERT INTO amrsemr_etl.etl_drug_event(
      uuid,
      patient_id,
      date_started,
      visit_date,
...
CREATE PROCEDURE sp_update_etl_ipt_screening(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_ipt_screening(
      patient_id,
      uuid,
      provider,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_ipt_follow_up(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_ipt_follow_up(
      patient_id,
      uuid,
      provider,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_ccc_defaulter_tracing(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_ccc_defaulter_tracing(
      uuid,
      provider,
      patient_id,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_ART_preparation(IN last_update_time DATETIME)
  BEGIN
    insert into amrsemr_etl.etl_ART_preparation(
      uuid,
      patient_id,
      visit_id,
      visit_date,
...
CREATE PROCEDURE sp_update_etl_enhanced_adherence(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_enhanced_adherence(
...
CREATE PROCEDURE sp_update_etl_generalized_anxiety_disorder(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_generalized_anxiety_disorder(
		uuid,
		patient_id,
		visit_id,
		visit_date,
...
CREATE PROCEDURE sp_update_etl_prep_behaviour_risk_assessment(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_prep_behaviour_risk_assessment(
      uuid,
      provider,
      patient_id,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_prep_monthly_refill(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_prep_monthly_refill(
      uuid,
      provider,
      patient_id,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_prep_discontinuation(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_prep_discontinuation(
      uuid,
      provider,
      patient_id,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_prep_enrolment(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_prep_enrolment(
      uuid,
      provider,
      patient_id,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_prep_followup(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_prep_followup(
        uuid,
        form,
        provider,
        patient_id,
...
CREATE PROCEDURE sp_update_etl_progress_note(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_progress_note(
      uuid,
      provider ,
      patient_id,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_ipt_initiation(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_ipt_initiation(
      patient_id,
      uuid,
      encounter_provider,
      visit_date ,
...
CREATE PROCEDURE sp_update_etl_ipt_followup(IN last_update_time DATETIME)
	BEGIN
		...
		INSERT INTO amrsemr_etl.etl_ipt_followup(
			uuid,
			patient_id,
			visit_id,
			visit_date,
...
CREATE PROCEDURE sp_update_etl_ipt_outcome(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_ipt_outcome(
      patient_id,
      uuid,
      encounter_provider,
      visit_date ,
...
CREATE PROCEDURE sp_update_etl_hts_linkage_tracing(IN last_update_time DATETIME)
  BEGIN
    ...
    INSERT INTO amrsemr_etl.etl_hts_linkage_tracing(
      uuid,
      patient_id,
      visit_date,
      location_id,
...
CREATE PROCEDURE sp_update_etl_otz_enrollment(IN last_update_time DATETIME)
  BEGIN
    ...
    INSERT INTO amrsemr_etl.etl_otz_enrollment(
      uuid,
      patient_id,
      visit_date,
      location_id,
...
CREATE PROCEDURE sp_update_etl_otz_activity(IN last_update_time DATETIME)
  BEGIN
    ...
    INSERT INTO amrsemr_etl.etl_otz_activity(
      uuid,
      patient_id,
      visit_date,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_ovc_enrolment(IN last_update_time DATETIME)
  BEGIN
    ...
    INSERT INTO amrsemr_etl.etl_ovc_enrolment(
      uuid,
      patient_id,
      visit_date,
      location_id,
...
CREATE PROCEDURE sp_update_etl_patient_program(IN last_update_time DATETIME)
  BEGIN
    ...
    INSERT INTO amrsemr_etl.etl_patient_program(
      uuid,
      patient_id,
      location_id,
      program,
...
CREATE PROCEDURE sp_update_etl_person_address(IN last_update_time DATETIME)
  BEGIN
    ...
    INSERT INTO amrsemr_etl.etl_person_address(
      uuid,
      patient_id,
      county,
      sub_county,
...
CREATE PROCEDURE sp_update_etl_cervical_cancer_screening(IN last_update_time DATETIME)
  BEGIN
   ...
   insert into amrsemr_etl.etl_cervical_cancer_screening(
    uuid,
    encounter_id,
    encounter_provider,
    patient_id,
...
CREATE PROCEDURE sp_update_etl_kp_contact(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_contact (
      uuid,
      client_id,
      visit_id,
      visit_date,
    ...
    update amrsemr_etl.etl_contact c
...
CREATE PROCEDURE sp_update_etl_kp_client_enrollment(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_client_enrollment (
      uuid,
      client_id,
      visit_id,
      visit_date,
...
CREATE PROCEDURE sp_update_etl_kp_clinical_visit(IN last_update_time DATETIME)
  BEGIN
    ...
    INSERT INTO amrsemr_etl.etl_clinical_visit(
      uuid,
      client_id,
      visit_id,
      visit_date,
...
CREATE PROCEDURE sp_update_etl_kp_sti_treatment(IN last_update_time DATETIME)
  BEGIN
    ...
    INSERT INTO amrsemr_etl.etl_sti_treatment(
      uuid,
      client_id,
      visit_id,
      visit_date,
...
CREATE PROCEDURE sp_update_etl_kp_peer_calendar(IN last_update_time DATETIME)
  BEGIN
    ...
    INSERT INTO  amrsemr_etl.etl_peer_calendar(
      uuid,
      client_id,
      visit_id,
      visit_date,
...
CREATE PROCEDURE sp_update_etl_kp_peer_tracking(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_peer_tracking(
      uuid,
      provider,
      client_id,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_kp_treatment_verification(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_treatment_verification(
      uuid,
      provider,
      client_id,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_gender_based_violence(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_gender_based_violence(
      uuid,
      provider,
      client_id,
      visit_id,
...
CREATE PROCEDURE sp_update_etl_PrEP_verification(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_PrEP_verification(
      uuid,
      provider,
      client_id,
      visit_id,
    ...
    insert into amrsemr_etl.etl_alcohol_drug_abuse_screening(
    patient_id,
    uuid,
    provider,
    visit_id,
    ...
    insert into amrsemr_etl.etl_gbv_screening(
        uuid,
        provider,
        patient_id,
        visit_id,
...
------updating etl_gbv_screening_action table-------
 DROP PROCEDURE IF EXISTS sp_update_etl_gbv_screening_action $$
    ...
    BEGIN
    SELECT "Processing GBV Screening", CONCAT("Time: ", NOW());
insert into amrsemr_etl.etl_gbv_screening_action(
    uuid,
    provider,
    patient_id,
    encounter_id,
...
insert into amrsemr_etl.etl_violence_reporting(
        uuid,
        provider,
        patient_id,
        visit_id,
...
insert into amrsemr_etl.etl_link_facility_tracking(
uuid,
provider,
patient_id,
visit_id,
...
-- Update Depression Screening
  ...
  DROP PROCEDURE IF EXISTS sp_update_etl_depression_screening $$
    ...
    insert into amrsemr_etl.etl_depression_screening(
      uuid,
      provider,
      patient_id,
      visit_id,
...
insert into amrsemr_etl.etl_adverse_events(
uuid ,
form,
provider,
patient_id,
...
insert into amrsemr_etl.etl_pre_hiv_enrollment_art(
    uuid,
    provider,
    patient_id,
    visit_id,
...
insert into amrsemr_etl.etl_covid19_assessment (uuid,
                                                 provider,
                                                 patient_id,
                                                 visit_id,
                                                 visit_date,
...
insert into amrsemr_etl.etl_vmmc_enrolment(
    uuid,
    provider,
    patient_id,
    visit_id,
...
insert into amrsemr_etl.etl_vmmc_circumcision_procedure(
    uuid,
    provider,
    patient_id,
    visit_id,
...
CREATE PROCEDURE sp_update_etl_vmmc_client_followup(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into amrsemr_etl.etl_vmmc_client_followup(
      uuid,
      provider,
      patient_id,
      visit_id,
...
BEGIN
    ...
    insert into amrsemr_etl.etl_vmmc_medical_history(
        uuid,
        provider,
        patient_id,
        visit_id,
...
insert into amrsemr_etl.etl_vmmc_post_operation_assessment(uuid,
            provider,
            patient_id,
            visit_id,
            visit_date,
...
INSERT INTO amrsemr_etl.etl_hts_eligibility_screening (
    patient_id,
    visit_id,
    encounter_id,
    uuid,
...
INSERT INTO amrsemr_etl.etl_drug_order (
    uuid,
    encounter_id,
    order_group_id,
    patient_id,
...
BEGIN
    ...
    insert into amrsemr_etl.etl_preventive_services(
        patient_id,
        visit_date,
        provider,
        location_id,
...
BEGIN
    ...
    INSERT INTO amrsemr_etl.etl_overdose_reporting (
        client_id,
        visit_id,
        encounter_id,
        uuid,
...
BEGIN
    ...
    INSERT INTO amrsemr_etl.etl_art_fast_track (uuid,
             provider,
             patient_id,
             visit_id,
             visit_date,
...
INSERT INTO amrsemr_etl.etl_patient_appointment(patient_appointment_id,
  provider_id, 
  patient_id, 
  visit_date, 
  start_date_time, 
...
BEGIN
  ...
  update amrsemr_etl.etl_patient_hiv_followup fup
    inner join amrsemr_etl.etl_patient_appointment pat on pat.patient_id = fup.patient_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 1
set fup.next_appointment_date = date(pat.start_date_time) where fup.patient_id > 0 and fup.date_created >= last_update_time;

 update amrsemr_etl.etl_patient_hiv_followup fup
    inner join amrsemr_etl.etl_patient_appointment pat on pat.patient_id = fup.patient_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 2
set fup.refill_date = date(pat.start_date_time) where fup.patient_id > 0 and fup.date_created >= last_update_time;

update amrsemr_etl.etl_prep_followup fup
    inner join amrsemr_etl.etl_patient_appointment pat on pat.patient_id = fup.patient_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 8
set fup.appointment_date = date(pat.start_date_time) where fup.patient_id > 0 and fup.date_created >= last_update_time;

update amrsemr_etl.etl_prep_monthly_refill fup
    inner join amrsemr_etl.etl_patient_appointment pat on pat.patient_id = fup.patient_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 9
set fup.next_appointment = date(pat.start_date_time) where fup.patient_id > 0 and fup.date_created >= last_update_time;

update amrsemr_etl.etl_tb_follow_up_visit fup
    inner join amrsemr_etl.etl_patient_appointment pat on pat.patient_id = fup.patient_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 6
set fup.next_appointment_date = date(pat.start_date_time) where fup.patient_id > 0 and fup.date_created >= last_update_time;

update amrsemr_etl.etl_clinical_visit fup
    inner join amrsemr_etl.etl_patient_appointment pat on pat.patient_id = fup.client_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 3
set fup.appointment_date = date(pat.start_date_time) where fup.client_id > 0 and fup.date_created>= last_update_time;

update amrsemr_etl.etl_mch_antenatal_visit fup
    inner join amrsemr_etl.etl_patient_appointment pat on pat.patient_id = fup.patient_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 4
set fup.next_appointment_date = date(pat.start_date_time) where fup.patient_id > 0 and fup.date_created >= last_update_time;

update amrsemr_etl.etl_mch_postnatal_visit fup
    inner join amrsemr_etl.etl_patient_appointment pat on pat.patient_id = fup.patient_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 5
set fup.appointment_date = date(pat.start_date_time) where fup.patient_id > 0 and fup.date_created >= last_update_time;

update amrsemr_etl.etl_hei_follow_up_visit fup
    inner join amrsemr_etl.etl_patient_appointment pat on pat.patient_id = fup.patient_id and pat.visit_date = fup.visit_date and pat.appointment_service_id = 13
set fup.next_appointment_date = date(pat.start_date_time) where fup.patient_id > 0 and fup.date_created >= last_update_time;
...
INSERT INTO amrsemr_etl.etl_clinical_encounter (
    patient_id,
    visit_id,
    encounter_id,
    uuid,
...
CREATE PROCEDURE sp_scheduled_updates()
  BEGIN
    ...
    SELECT max(start_time) into last_update_time from amrsemr_etl.etl_script_status where stop_time is not null;

    INSERT INTO amrsemr_etl.etl_script_status(script_name, start_time) VALUES('scheduled_updates', NOW());
    ...
    UPDATE amrsemr_etl.etl_script_status SET stop_time=NOW() where  id= update_script_id;
    DELETE FROM amrsemr_etl.etl_script_status where script_name in ("AMRS_Data_Tool", "scheduled_updates") and start_time < DATE_SUB(NOW(), INTERVAL 12 HOUR);
